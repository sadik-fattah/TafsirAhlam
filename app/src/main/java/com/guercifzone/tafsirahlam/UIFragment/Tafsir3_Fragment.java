...
import com.guercifzone.tafsirahlam.JsonParser.Tafsir_3;
import com.guercifzone.tafsirahlam.R;

import java.util.List;

public class Tafsir3_Fragment extends Fragment {
    //حرف التاء
    public Tafsir3_Fragment(){}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Tafsir_3.SectionGroupOne> sections = Tafsir_3.readJsonFile(requireContext());
        for (Tafsir_3.SectionGroupOne section : sections) {
