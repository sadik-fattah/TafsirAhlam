...
import com.guercifzone.tafsirahlam.JsonParser.Tafsir_12;
import com.guercifzone.tafsirahlam.R;

import java.util.List;

public class Tafsir12_Fragment extends Fragment {
    //حرف  السين
    public Tafsir12_Fragment(){}
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Tafsir_12.SectionGroupOne> sections = Tafsir_12.readJsonFile(requireContext());
        for (Tafsir_12.SectionGroupOne section : sections) {
