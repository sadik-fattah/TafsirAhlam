...
import com.guercifzone.tafsirahlam.JsonParser.Tafsir_8;
import com.guercifzone.tafsirahlam.R;

import java.util.List;

public class Tafsir8_Fragment extends Fragment {
    //حرف الدال
    public Tafsir8_Fragment(){}
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Tafsir_8.SectionGroupOne> sections = Tafsir_8.readJsonFile(requireContext());
        for (Tafsir_8.SectionGroupOne section : sections) {
