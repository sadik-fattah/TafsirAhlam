...
import com.guercifzone.tafsirahlam.JsonParser.Tafsir_20;
import com.guercifzone.tafsirahlam.R;

import java.util.List;

public class Tafsir20_Fragment extends Fragment {
    //حرف الفاء
            public Tafsir20_Fragment(){}
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Tafsir_20.SectionGroupOne> sections = Tafsir_20.readJsonFile(requireContext());
        for (Tafsir_20.SectionGroupOne section : sections) {
