...
import com.guercifzone.tafsirahlam.JsonParser.Tafsir_17;
import com.guercifzone.tafsirahlam.R;

import java.util.List;

public class Tafsir17_Fragment extends Fragment {
    //حرف الظاء
    public Tafsir17_Fragment(){}
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Tafsir_17.SectionGroupOne> sections = Tafsir_17.readJsonFile(requireContext());
        for (Tafsir_17.SectionGroupOne section : sections) {
