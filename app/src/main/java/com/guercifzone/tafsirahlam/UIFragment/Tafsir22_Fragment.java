...
import com.guercifzone.tafsirahlam.JsonParser.Tafsir_22;
import com.guercifzone.tafsirahlam.R;

import java.util.List;

public class Tafsir22_Fragment extends Fragment {
    //حرف الكاف
    public Tafsir22_Fragment(){}
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Tafsir_22.SectionGroupOne> sections = Tafsir_22.readJsonFile(requireContext());
        for (Tafsir_22.SectionGroupOne section : sections) {
