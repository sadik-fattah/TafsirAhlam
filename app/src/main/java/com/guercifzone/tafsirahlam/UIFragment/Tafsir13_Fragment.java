...
import com.guercifzone.tafsirahlam.JsonParser.Tafsir_13;
import com.guercifzone.tafsirahlam.R;

import java.util.List;

public class Tafsir13_Fragment extends Fragment {
    //حرف  الشين
    public Tafsir13_Fragment(){}
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Tafsir_13.SectionGroupOne> sections = Tafsir_13.readJsonFile(requireContext());
        for (Tafsir_13.SectionGroupOne section : sections) {
