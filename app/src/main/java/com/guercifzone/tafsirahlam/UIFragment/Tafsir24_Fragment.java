...
import com.guercifzone.tafsirahlam.JsonParser.Tafsir_24;
import com.guercifzone.tafsirahlam.R;

import java.util.List;

public class Tafsir24_Fragment extends Fragment {
    //حرف الميم
    public Tafsir24_Fragment(){}
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Tafsir_24.SectionGroupOne> sections = Tafsir_24.readJsonFile(requireContext());
        for (Tafsir_24.SectionGroupOne section : sections) {
