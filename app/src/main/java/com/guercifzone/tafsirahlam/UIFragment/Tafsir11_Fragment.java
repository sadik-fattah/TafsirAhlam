...
import com.guercifzone.tafsirahlam.JsonParser.Tafsir_11;
import com.guercifzone.tafsirahlam.R;

import java.util.List;

public class Tafsir11_Fragment extends Fragment {
    //حرف  الزين
    public Tafsir11_Fragment(){}
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Tafsir_11.SectionGroupOne> sections = Tafsir_11.readJsonFile(requireContext());
        for (Tafsir_11.SectionGroupOne section : sections) {
