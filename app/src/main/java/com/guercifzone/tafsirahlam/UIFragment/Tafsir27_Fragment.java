...
import com.guercifzone.tafsirahlam.JsonParser.Tafsir_27;
import com.guercifzone.tafsirahlam.R;

import java.util.List;

public class Tafsir27_Fragment extends Fragment {
    //حرف الواو
    public Tafsir27_Fragment(){}
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Tafsir_27.SectionGroupOne> sections = Tafsir_27.readJsonFile(requireContext());
        for (Tafsir_27.SectionGroupOne section : sections) {
