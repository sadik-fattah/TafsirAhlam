...
import com.guercifzone.tafsirahlam.JsonParser.Tafsir_15;
import com.guercifzone.tafsirahlam.R;

import java.util.List;

public class Tafsir15_Fragment extends Fragment {
    //حرف  الضاد
    public Tafsir15_Fragment(){}
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Tafsir_15.SectionGroupOne> sections = Tafsir_15.readJsonFile(requireContext());
        for (Tafsir_15.SectionGroupOne section : sections) {
