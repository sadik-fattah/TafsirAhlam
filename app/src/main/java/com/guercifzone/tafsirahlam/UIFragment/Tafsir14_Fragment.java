...
import com.guercifzone.tafsirahlam.JsonParser.Tafsir_14;
import com.guercifzone.tafsirahlam.R;

import java.util.List;

public class Tafsir14_Fragment extends Fragment {
    //حرف الصاد
    public Tafsir14_Fragment(){}
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Tafsir_14.SectionGroupOne> sections = Tafsir_14.readJsonFile(requireContext());
        for (Tafsir_14.SectionGroupOne section : sections) {
