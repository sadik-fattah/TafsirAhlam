...
import com.guercifzone.tafsirahlam.JsonParser.Tafsir_23;
import com.guercifzone.tafsirahlam.R;

import java.util.List;

public class Tafsir23_Fragment extends Fragment {
    //حرف اللام
    public Tafsir23_Fragment(){}
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Tafsir_23.SectionGroupOne> sections = Tafsir_23.readJsonFile(requireContext());
        for (Tafsir_23.SectionGroupOne section : sections) {
