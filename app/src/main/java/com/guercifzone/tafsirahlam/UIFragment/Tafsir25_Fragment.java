...
import com.guercifzone.tafsirahlam.JsonParser.Tafsir_25;
import com.guercifzone.tafsirahlam.R;

import java.util.List;

public class Tafsir25_Fragment extends Fragment {
    //حرف النون
    public Tafsir25_Fragment(){}
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Tafsir_25.SectionGroupOne> sections = Tafsir_25.readJsonFile(requireContext());
        for (Tafsir_25.SectionGroupOne section : sections) {
