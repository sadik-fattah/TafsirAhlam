...
import com.guercifzone.tafsirahlam.JsonParser.Tafsir_10;
import com.guercifzone.tafsirahlam.R;

import java.util.List;

public class Tafsir10_Fragment extends Fragment {
    // الراء حرف
    public Tafsir10_Fragment(){}
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Tafsir_10.SectionGroupOne> sections = Tafsir_10.readJsonFile(requireContext());
        for (Tafsir_10.SectionGroupOne section : sections) {
