...
import com.guercifzone.tafsirahlam.JsonParser.Tafsir_19;
...
public class Tafsir19_Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Tafsir_19.SectionGroupOne> sections = Tafsir_19.readJsonFile(requireContext());
        for (Tafsir_19.SectionGroupOne section : sections) {
