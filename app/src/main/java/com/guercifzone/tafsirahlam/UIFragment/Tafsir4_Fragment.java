...
public class Tafsir4_Fragment extends Fragment {
    //حرف الثاء
    public Tafsir4_Fragment(){}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Tafsir_4.SectionGroupOne> sections = Tafsir_4.readJsonFile(requireContext());
        for (Tafsir_4.SectionGroupOne section : sections) {
