...
public class Tafsir_25 {
    public static List<Tafsir_25.SectionGroupOne> readJsonFile(Context context) {
        List<Tafsir_25.SectionGroupOne> sectionsList = new ArrayList<>();
        try {
            Resources resources = context.getResources();
            InputStream inputStream = resources.openRawResource(R.raw.tafsir_25);
            ...
            for (int i = 0; i < sections.length(); i++) {
                ...
                if (content instanceof String) {
                    sectionsList.add(new Tafsir_25.SectionGroupOne(sectionTitle, (String) content));
                    ...
                    sectionsList.add(new Tafsir_25.SectionGroupOne(sectionTitle, contentBuilder.toString()));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
