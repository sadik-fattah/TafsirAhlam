...
public class Tafsir_10 {
    public static List<Tafsir_10.SectionGroupOne> readJsonFile(Context context) {
        List<Tafsir_10.SectionGroupOne> sectionsList = new ArrayList<>();
        try {
            Resources resources = context.getResources();
            InputStream inputStream = resources.openRawResource(R.raw.tafsir_10);
            ...
            for (int i = 0; i < sections.length(); i++) {
                ...
                if (content instanceof String) {
                    sectionsList.add(new Tafsir_10.SectionGroupOne(sectionTitle, (String) content));
                    ...
                    sectionsList.add(new Tafsir_10.SectionGroupOne(sectionTitle, contentBuilder.toString()));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
