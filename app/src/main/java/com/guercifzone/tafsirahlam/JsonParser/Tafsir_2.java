...
public class Tafsir_2 {
    public static List<Tafsir_1.SectionGroupOne> readJsonFile(Context context) {
        List<Tafsir_1.SectionGroupOne> sectionsList = new ArrayList<>();
        try {
            ...
            for (int i = 0; i < sections.length(); i++) {
                ...
                if (content instanceof String) {
                    sectionsList.add(new Tafsir_1.SectionGroupOne(sectionTitle, (String) content));
                    ...
                    sectionsList.add(new Tafsir_1.SectionGroupOne(sectionTitle, contentBuilder.toString()));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
