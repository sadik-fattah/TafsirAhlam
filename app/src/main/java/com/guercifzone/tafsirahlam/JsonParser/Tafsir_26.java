...
public class Tafsir_26 {
    public static List<Tafsir_26.SectionGroupOne> readJsonFile(Context context) {
        List<Tafsir_26.SectionGroupOne> sectionsList = new ArrayList<>();
        try {
            Resources resources = context.getResources();
            InputStream inputStream = resources.openRawResource(R.raw.tafsir_26);
            ...
            for (int i = 0; i < sections.length(); i++) {
                ...
                if (content instanceof String) {
                    sectionsList.add(new Tafsir_26.SectionGroupOne(sectionTitle, (String) content));
                    ...
                    sectionsList.add(new Tafsir_26.SectionGroupOne(sectionTitle, contentBuilder.toString()));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
