...
public class Tafsir_1 {
    public static List<SectionGroupOne> readJsonFile(Context context) {
        ...
        try {
            ...
            InputStream inputStream = resources.openRawResource(R.raw.tafsir_1);
            ...
            for (int i = 0; i < sections.length(); i++) {
                ...
                if (content instanceof String) {
                    sectionsList.add(new SectionGroupOne(sectionTitle, (String) content));
                    ...
                    sectionsList.add(new SectionGroupOne(sectionTitle, contentBuilder.toString()));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
