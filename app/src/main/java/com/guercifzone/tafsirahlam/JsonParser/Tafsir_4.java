...
public class Tafsir_4 {
    public static List<Tafsir_4.SectionGroupOne> readJsonFile(Context context) {
        List<Tafsir_4.SectionGroupOne> sectionsList = new ArrayList<>();
        try {
            Resources resources = context.getResources();
            InputStream inputStream = resources.openRawResource(R.raw.tafsir_4);
            ...
            for (int i = 0; i < sections.length(); i++) {
                ...
                if (content instanceof String) {
                    sectionsList.add(new Tafsir_4.SectionGroupOne(sectionTitle, (String) content));
                    ...
                    sectionsList.add(new Tafsir_4.SectionGroupOne(sectionTitle, contentBuilder.toString()));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
